        ...
        <el-tab-pane label="工资信息">
          <el-form label-width="180px">
            ...
            <el-form-item label="基本工资" class="is-required">
              <el-input-number v-model="personalAll.personalSalaryInfo.basePay" :step="500" :min="0" :max="20000" :disabled="true"></el-input-number>
            </el-form-item>
            <el-form-item label="绩效工资" class="is-required">
              <el-input-number v-model="personalAll.personalSalaryInfo.meritPay" :step="500" :min="0" :max="10000" :disabled="true"></el-input-number>
            </el-form-item>
            <el-form-item label="试用期">
              <el-input v-model="personalAll.personalSalaryInfo.probationPeriod" :disabled="true"></el-input>
            </el-form-item>
            <el-form-item label="试用期工资">
              <el-input-number v-model="personalAll.personalSalaryInfo.probationaryPay" :step="500" :min="0" :max="20000" :disabled="true"></el-input-number>
            </el-form-item>
            ...
            <el-form-item label="补贴" class="is-required">
              <el-input-number v-model="personalAll.personalSalaryInfo.subsidy" :step="100" :min="0" :max="5000" :disabled="true"></el-input-number>
            </el-form-item>
            <el-form-item label="转正工资">
              <el-input-number v-model="personalAll.personalSalaryInfo.workerPay" :step="500" :min="0" :max="20000" :disabled="true"></el-input-number>
            </el-form-item>
            ...
            <el-form-item label="缴纳社保起始月份">
              <el-date-picker v-model="personalAll.personalSalaryInfo.insuranceBeginDate" type="date" :editable="true" placeholder="缴纳社保起始月份" :disabled="true">
              </el-date-picker>
            </el-form-item>
            <el-form-item label="实际缴纳社保起始月份">
              <el-date-picker v-model="personalAll.personalSalaryInfo.insuranceRealDate" type="date" :editable="true" placeholder="实际缴纳社保起始月份" :disabled="true">
              </el-date-picker>
            </el-form-item>
            ...
            <el-form-item label="结算价">
              <el-input-number v-model="personalAll.personalSalaryInfo.settlementPrice" :step="500" :min="3000" :max="20000" :disabled="true"></el-input-number>
            </el-form-item>
