  ...
  <el-menu class="navbar" mode="horizontal">
    ...
    <div class="right-menu">
      <div class="right-menu-item">
        <span>
          <i class="fa fa-user"></i>&nbsp;{{items.name}}
        </span>
        <span>
        <i class="fa fa-role"></i>&nbsp;{{items.roles}}
        </span>
      </div>
      <el-dropdown class="avatar-container right-menu-item" trigger="click">
        <div class="avatar-wrapper">
        <img class="user-avatar" src="@/assets/images/home/logo.png">
...
export default {
  ...
  mounted: function() {
    ...
    this.items.roles = sessionStorage.getItem("roles");
  }
};
</script>
